...
func TestFactoryFunctions(t *testing.T) {
	testCases := []struct {
		encodingType types.ContentEncodingType
		level        int
	}{
		{types.ContentEncodingGzip, 6},
		{types.ContentEncodingDeflate, 6},
		{types.ContentEncodingBr, 6},
		{types.ContentEncodingZstd, 3},
		{types.ContentEncodingCompress, 0},
		{types.ContentEncodingIdentity, 0},
	}
...
func TestUnsupportedEncoding(t *testing.T) {
	unsupportedType := types.ContentEncodingType("unsupported")
