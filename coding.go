...
// EncoderFactory creates encoders based on ContentEncodingType
func CreateEncoder(encodingType ContentEncodingType, level int) (Encoder, error) {
	switch encodingType {
...
// DecoderFactory creates decoders based on ContentEncodingType
func CreateDecoder(encodingType ContentEncodingType) (Decoder, error) {
	switch encodingType {
	case ContentEncodingGzip:
...
func EncodeData(data []byte, encodingType ContentEncodingType, level int) ([]byte, error) {
...
func DecodeData(data []byte, encodingType ContentEncodingType) ([]byte, error) {
